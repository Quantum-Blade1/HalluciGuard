...
class RegistryResult:
    ...
    # Backwards compatibility wrappers for pipeline
    @property
...
class RegistryClient:
    ...
    async def batch_check(self, packages: list[tuple[str, str]]) -> list[RegistryResult]:
        return await self.check_packages(packages)
