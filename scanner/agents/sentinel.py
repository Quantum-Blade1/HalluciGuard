...
from scanner.config import PYTHON_STDLIB, JS_BUILTINS
from scanner.utils.ast_parser import ASTParser
from scanner.utils.module_to_package import module_to_package, is_relative_import
